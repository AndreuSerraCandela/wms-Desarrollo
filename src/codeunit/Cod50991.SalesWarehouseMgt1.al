...
codeunit 50991 "Sales Warehouse Mgt1" // 5991 "Sales Warehouse Mgt."
{
    var
#if not CLEAN23
    ...
    procedure FromSalesLine2ShptLine(WarehouseShipmentHeader: Record "Warehouse Shipment Header"; SalesLine: Record "Sales Line"; LCantidadAEnviar: Boolean) Result: Boolean
    var
    ...
    begin
        ...
        if NOT LCantidadAEnviar then begin
    ...
    begin
        ...
        with WarehouseShipmentLine do begin
            ...
            WarehouseShipmentLine."Cod. temporada" := SalesLine."Shortcut Dimension 1 Code";

            WarehouseShipmentLine.PfsSubline := SalesLine.PfsSubline;
            WarehouseShipmentLine."PfsMatrix Line No." := SalesLine."PfsMatrix Line No.";
            ...
            SetQtysOnShptLine(WarehouseShipmentLine, WhseShptLineQty, WhseShptLineQtyBase);
            ...
            if RItemVarian.get(WarehouseShipmentLine."Item No.", WarehouseShipmentLine."Variant Code") then
                "PfsItem Status" := RItemVarian."Item Status";
