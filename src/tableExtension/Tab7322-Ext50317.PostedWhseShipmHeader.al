/// <summary>
/// TableExtension PostedWhseShipmHeader (ID 50217) extends Record Posted Whse. Shipment Header //7322.
/// </summary>
tableextension 50317 PostedWhseShipmHeader extends "Posted Whse. Shipment Header" //7322
{
    fields
    {
        ...
        {
            DataClassification = ToBeClassified;
            Caption = 'Sell-to Country/Region Code', comment = 'ESP="Venta a-Cód.país/región"';
            Description = 'EX-SGG-WMS 170719';
            TableRelation = "Country/Region";
